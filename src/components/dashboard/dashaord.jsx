...
const DashBoards = (props) => {
    ...
    const getData = async () => {
        try {
            ...
            await axios.get(`${serverLink}dashboard/charts/transactions`, token).then((res) => {
                if (res.data.length > 0) {
            ...
            await axios.get(`${serverLink}dashboard/charts/loans`, token).then((res) => {
                if (res.data.length > 0) {
            ...
            await axios.get(`${serverLink}dashboard/charts/active-loan`, token).then((res) => {
                if (res.data.length > 0) {
                ...
                <div className="container-xl">
                    <div className="row row-deck row-cards">
                                    ...
                                    <div className="card card-sm">
                                        <div className="card-body">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col">
                                                    <div className="font-weight-medium" style={{ fontWeight: 'bolder' }} >
                        ...
                        <div className="col-lg-6">
                            <div className="card">
                                <div className="card-body">
                                    <h3 className="card-title">Customer Loan Records</h3>
                        ...
                        <div className="col-lg-6">
                            <div className="card">
                                <div className="card-body">
                                    <h3 className="card-title">Customer Loan Volume</h3>
                                    <div className="ratio ratio-21x9">
                                        {
                                            LoanBarChart !== "" &&
                                            <ReactApexChart
