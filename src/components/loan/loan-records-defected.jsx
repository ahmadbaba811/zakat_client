...
const LoanRecordsDefected = (props) => {
    const token = props.loginData[0].token;
    const [data, setData] = useState([]);
    const columns = ["SN", "CustomerID", "Type", "Amount Applied", "Branch", "Last Due Date", "App. Status", "Loan Status", "IsDefected", "Action"];
                ...
                if (res.data.length > 0) {
                    ...
                    res.data.map((x, i) => {
                        rows.push([
                            ...
                            <span className={x.IsDefected === 1 ?
                                "badge bg-danger" : "badge bg-success"}>
                                {x.IsDefected === 1 ? "DEFECTED" : "NOT DEFECTED"}
                            </span>,
    ...
    return (
        <div className="page-wrapper">
            <PageHeader target="modal-large" title={["Defected Loans", "Loans", "Defected Loans"]} />
...
export default connect(mapStateToProps, null)(LoanRecordsDefected)
