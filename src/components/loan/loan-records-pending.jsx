...
const LoanRecordsPending = (props) => {
    ...
    const getData = async () => {
        try {
            await axios.get(`${serverLink}loan/pending/list/${props.loginData[0]?.Branch}`, token).then((res) => {
    ...
    return (
        <div className="page-wrapper">
            <PageHeader target="modal-large"  title={["Pending Loans", "Loans", "Pending Loans"]} />
...
export default connect(mapStateToProps, null)(LoanRecordsPending)
